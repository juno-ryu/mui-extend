    ...
    <div className="max-w-5xl mx-auto space-y-12">
      ...
      <div className="space-y-6">
        ...
        <p className="text-muted-foreground ">
          MUI 기반 커스텀 디자인 시스템 컴포넌트를 탐색하고 사용법을 확인할 수
          있는 쇼케이스 사이트입니다.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>
            <strong className="text-foreground">MUI Extend</strong>는
            Material-UI를 기반으로 커스터마이징된 디자인 시스템 컴포넌트를
            문서화하고 시연하는 쇼케이스 플랫폼입니다.
          </p>
          <span>이 프로젝트는 </span>
          ...
          <span>
            {" "}
            에 정의된 커스텀 컴포넌트들을 개발자들이 쉽게 탐색하고, 각
            컴포넌트의 사용법과 MUI 원본과의 차이점을 확인할 수 있도록
            만들었습니다.
          </span>
        </div>
      </div>
